...
function createSlot4(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React20.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React20.Children.count(newElement) > 1)
            return React20.Children.only(null);
          return React20.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React20.isValidElement(newElement) ? React20.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperAnchor = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime17.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React25.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Portal = React27.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime20.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React28.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React28.Children.count(newElement) > 1)
            return React28.Children.only(null);
          return React28.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime21.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React28.isValidElement(newElement) ? React28.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React28.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var useReactEffectEvent = React30[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React30[" useInsertionEffect ".trim().toString()];

// node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = React31[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React33.Children.count(newElement) > 1)
            return React33.Children.only(null);
...
function isSlottable8(child) {
  return React33.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var VisuallyHidden = React35.forwardRef(
  (props, forwardedRef) => {
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime26.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime26.jsxs)(
    SelectProvider,
    {
      ...
      disabled,
      children: [
        (0, import_jsx_runtime26.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime26.jsx)(
...
var SelectIcon = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(Primitive6.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM10.createPortal(
        (0, import_jsx_runtime26.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime26.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime26.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var SelectContentImpl = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleItemLeave = React45.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime26.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime26.jsx)(Combination_default, { as: Slot9, allowPinchZoom: true, children: (0, import_jsx_runtime26.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
      ...
      (0, import_jsx_runtime26.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime26.jsx)(
        Primitive6.div,
        {
...
var SelectGroup = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime26.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime26.jsx)(Primitive6.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(Primitive6.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
      (0, import_jsx_runtime26.jsx)(Primitive6.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime26.jsx)(Primitive6.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(Primitive6.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
